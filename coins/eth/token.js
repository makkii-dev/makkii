...
function getTopTokens(topN = 20) {
    return new Promise((resolve, reject) => {
        const url = `${Config.app_server_api}/token/eth/search?offset=0&limit=${topN}`;
...
function searchTokens(keyword) {
    return new Promise((resolve, reject) => {
        const url = `${Config.app_server_api}/token/eth/search?offset=0&limit=20&keyword=${keyword}`;
