...
const unsigned = createStackNavigator({
  	...
  	"unsigned_register-mnemonic": {screen: RegisterMnemonic, navigationOptions: {headerStyle:styles.headerStyle, headerTitleStyle:styles.headerTitleStyle}}, 
  	...
  	"unsigned_recovery-password": {screen: RecoveryPassword, navigationOptions: {headerStyle:styles.headerStyle, headerTitleStyle:styles.headerTitleStyle}},
  	"unsigned_recovery-scan": {screen: RecoveryScan, navigationOptions: {header: null}},
}, {
