...
import Login                 	from './pages/unsigned/login.js';
import Register              	from './pages/unsigned/register.js';
import RegisterMnemonic      	from './pages/unsigned/register_mnemonic.js';
import Recovery              	from './pages/unsigned/recovery.js';
import Vault                	from './pages/signed/vault/home.js';
import VaultAccount         	from './pages/signed/vault/account.js';
import VaultAccountTokens       from './pages/signed/vault/account_tokens.js';
...
import VaultImportPrivateKey 	from './pages/signed/vault/import_private_key.js';
import VaultReceive          	from './pages/signed/vault/receive.js';
import VaultSend             	from './pages/signed/vault/send.js';
import VaultTransaction      	from './pages/signed/vault/transaction.js';
import VaultTransactionHistory 	from './pages/signed/vault/transaction_history.js';
import VaultSetAccountName   from './pages/signed/vault/set_account_name.js';
import VaultExportPRivateKey    from './pages/signed/vault/export_private_key.js';
import Dapps                 	from './pages/signed/dapps/home.js';
import DappsDapp             	from './pages/signed/dapps/dapp.js';
import DappsLaunch           	from './pages/signed/dapps/launch.js';
import DappsSend 	         	from './pages/signed/dapps/dapp_send.js';
import Dex                      from './pages/signed/dex/home.js';
import DexTAccountList          from './pages/signed/dex/account_list.js';
import DexExchangeTokenList     from './pages/signed/dex/exchange_token_list.js';
import DexExchangeHistory       from './pages/signed/dex/exchange_history.js';
import Setting               	from './pages/signed/setting/home.js';
import SettingAbout          	from './pages/signed/setting/about.js';
import SettingPassword       	from './pages/signed/setting/password.js';
import SettingRecovery       	from './pages/signed/setting/recovery.js';
import SettingLanguage      	from './pages/signed/setting/language.js';
import SettingAdvanced       	from './pages/signed/setting/advanced.js';
import SettingCurrency       	from './pages/signed/setting/currency.js';
import SettingPinCode           from './pages/signed/setting/pinCode.js';
import SettingAddressBook       from './pages/signed/setting/address_book.js';
import SettingAddAddress        from './pages/signed/setting/add_address.js';
import RecoveryPassword      	from './pages/unsigned/recovery_password.js';
